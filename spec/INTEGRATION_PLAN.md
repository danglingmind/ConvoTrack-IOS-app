...
class AppState: ObservableObject {
    ...
    @Published var currentUser: ConvoyUser? = nil       // set after Clerk sign-in
...
```swift
// Auth
struct ConvoyUser: Codable { let id, name: String; let avatarUrl: String? }
...
### Files changed
- `convoyApp.swift` — configure Clerk
