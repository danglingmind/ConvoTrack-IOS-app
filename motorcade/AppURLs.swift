...
// TODO: [B6] Ensure https://vynl.in/motorcade/privacy and /terms are published and reachable
// before App Store submission. Apple reviewers click these links — a 404 causes rejection.
// NOTE: served by the `noto` repo at src/app/motorcade/{privacy,terms} (clean cutover, no /convoy redirect).
enum AppURLs {
    static let privacyPolicy = "https://vynl.in/motorcade/privacy"
    static let termsOfService = "https://vynl.in/motorcade/terms"
