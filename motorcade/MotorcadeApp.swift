...
final class MotorcadeAppDelegate: NSObject, UIApplicationDelegate {
...
@main
struct MotorcadeApp: App {
    @UIApplicationDelegateAdaptor(MotorcadeAppDelegate.self) var delegate
    ...
    // Handles motorcade://join/INVITECODE
    private func handleDeepLink(_ url: URL) {
        guard url.scheme == "motorcade",
...
extension Notification.Name {
    static let motorcadeJoinRide = Notification.Name("motorcadeJoinRide")
}
