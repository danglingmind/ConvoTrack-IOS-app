...
struct MainTabView: View {
    @State private var activeTab: MotorcadeBottomNav.Tab = .track
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            if !appState.isRideActive {
                MotorcadeBottomNav(activeTab: $activeTab)
            }
        }
        ...
        .onReceive(NotificationCenter.default.publisher(for: .motorcadeJoinRide)) { note in
